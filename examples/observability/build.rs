//! Build script for observability example
//!
//! Generates SOAP client code from the calculator WSDL at build time.
...
fn main() {
    // Get the directory containing Cargo.toml (examples/observability/)
    let manifest_dir = env::var("CARGO_MANIFEST_DIR").expect("CARGO_MANIFEST_DIR not set");
    // Navigate from examples/observability/ to testdata/wsdl/calculator.wsdl
